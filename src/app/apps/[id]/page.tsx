...
import InstallAppButton from "@/components/button/AppButton";
...
export async function generateStaticParams() {
    const allApps = await getTrandingAppData();

    // console.log(allApps, "allApps");
    return allApps.map((app: IAppType) => {
...
const AppDetails = async ({ params }: TAppDetailsProps) => {
    ...
    const app = allApps.find((app: IAppType) => app.id === Number(id));
